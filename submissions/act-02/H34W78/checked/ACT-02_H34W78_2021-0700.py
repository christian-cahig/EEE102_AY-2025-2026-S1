 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "V_s = 13.8e3        # Source voltage (RMS)\n",
    "Z_line = 1.0 + 1j*2.5  # Feeder impedance \n",
    "\n",
    "# Load 1: 400 kW at 0.85 lagging PF\n",
    "P1 = 400e3\n",
    "pf1 = 0.85\n",
    "Q1 = P1 * np.tan(np.arccos(pf1))\n",
    "\n",
    "# Load 2: 300 kVAr at 0.75 lagging PF\n",
    "Q2 = 300e3\n",
    "pf2 = 0.75  \n",
    "\n",
    ...
    "\n",
    "def f(V):\n",
    "    \"\"\"Function whose root corresponds to the load bus voltage magnitude (V).\"\"\"\n",
    "    # Compute current from load: I = S*/V*\n",
    "    I = np.conj(S_total) / np.conj(V)\n",
    "    V_drop = I * Z_line\n",
    "    return np.abs(V + V_drop) - V_s\n",
    "\n",
    "def df_dV(V):\n",
    "    \"\"\"Derivative of f(V) with respect to V (finite difference).\"\"\"\n",
    "    h = 1e-6\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "The RMS voltage at the common bus is 13.670503226104605 kilovolts.\n"
     ]
    }
   ],
   "source": [
    ...
    "\n",
    "\n",
    "# Display results (Since I can't change the \"result\" 13670.503226104605 kilovolts)\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      " function_calls: 6\n",
      "     iterations: 3\n",
      "           root: 13670.503226104605\n",
      "         method: newton\n",
      "Residual value: 119827.87109367287\n"
     ]
    }
   ],
   "source": [
